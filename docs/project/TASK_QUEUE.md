...
- [x] DE-B7: Add developer helper to start notifications daemon with D-Bus ownership wait and optional swaync masking.
...
- [x] DE-E10: Switch CI workflow release guard step to unified `scripts/check_release_contracts.sh` entrypoint.
...
- [x] DE-B7: Added `scripts/dev_notif_start.sh` to stabilize local notification takeover/startup race handling
...
- [x] DE-E10: CI now runs unified release contracts entrypoint instead of standalone release-validate guard
