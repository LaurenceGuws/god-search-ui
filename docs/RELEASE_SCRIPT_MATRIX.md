...
| `scripts/cut_release_tag.sh` | Tag cut flow with preflight | `scripts/cut_release_tag.sh --version v0.1.1` | `scripts/cut_release_tag.sh --version v0.1.1 --apply --commit-notes --reuse-notes --push` |
...
3. `scripts/cut_release_tag.sh --version vX.Y.Z --apply --commit-notes --reuse-notes`
