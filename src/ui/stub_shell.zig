    ...
    pub fn run(allocator: std.mem.Allocator, service: *app.SearchService, _: *app.TelemetrySink) !void {
        ...
        while (true) {
            ...
            if (std.mem.startsWith(u8, query, ":icondiag")) {
                ...
                try printIconDiagnostics(allocator, stdout, service, json);
                continue;
            }
...
fn printIconDiagnostics(allocator: std.mem.Allocator, writer: anytype, service: *app.SearchService, json: bool) !void {
