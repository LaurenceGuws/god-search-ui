...
require "$README" 'god-search-ui --ui-daemon' 'README quickstart daemon command'
require "$README" 'god-search-ui --ctl ping' 'README quickstart ping command'
require "$README" 'god-search-ui --ctl summon' 'README quickstart summon command'
...
require "$DOC" 'god-search-ui --ui-daemon' 'CONTROL_PLANE manual daemon command'
require "$DOC" 'god-search-ui --ctl ping' 'CONTROL_PLANE manual ping command'
require "$DOC" 'god-search-ui --ctl shell_health' 'CONTROL_PLANE manual smoke shell_health command'
require "$DOC" 'scripts/control_plane_smoke.sh' 'CONTROL_PLANE manual smoke script reference'
